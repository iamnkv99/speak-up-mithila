...
mongoose.connect("mongodb://localhost/sum",{ useNewUrlParser: true ,useUnifiedTopology: true})
...
///////////
var conn = mongoose.createConnection("mongodb://localhost/sum", { useNewUrlParser: true , useUnifiedTopology: true });
//init gfs
let gfs;
conn.once('open',  () => {
